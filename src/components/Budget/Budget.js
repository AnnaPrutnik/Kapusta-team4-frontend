...
const Budget = () => {
  ...
  //есть установленный пакет React-responsive - с помощью него можно динамически узнавать ширину экрана, посмотри в компоненте Chart!!
  const [width, setWidth] = useState(innerWidth)
  //////// innerWidth - не будет вычислять ширину при изменении экрана, она высчитывается в момент загрузки
  ...
  const mergeArrays =
    width < 767
      ? mass1.concat(mass2)
      : (expenseBtn && mass1) || (incomeBtn && mass2)
